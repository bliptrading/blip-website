        ...
        <>
          <div>
            ...
            <p className="py-4 text-base font-medium">
              ...
              <span className="font-semibold ">
                {cartArray.length}{" "}
                {cartArray.length === 1 ? "product" : "products"}{" "}
              </span>
              in your cart
            </p>
          </div>
          ...
          <section className="flex flex-col justify-between py-10 lg:flex-row">
            ...
            <div className="p-5 my-8 ml-0 border rounded-md lg:w-4/12 lg:ml-4 h-fit">
              ...
              <div className="flex justify-between py-3">
                <h1 className="py-3 text-lg font-semibold">Discount:</h1>
                <p className="text-lg font-medium">${billings.discount}.00</p>
              </div>
              <div className="flex justify-between py-3">
                <h1 className="py-3 text-lg font-semibold">Shipping Fee:</h1>
                <p className="text-lg font-medium">${billings.shipping}.00</p>
              </div>
              <div className="flex justify-between py-3 border-b">
                <h1 className="py-3 text-lg font-semibold">Estimated Tax:</h1>
                <p className="text-lg font-medium">${billings.tax}.50</p>
              </div>
              <div className="flex items-center justify-between py-3">
                <h1 className="py-5 text-lg font-semibold">Total:</h1>
              ...
              <button
                className="w-full p-3 text-white bg-red-500 rounded-md"
                onClick={() => {
